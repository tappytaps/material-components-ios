...
@interface FlexibleHeaderHeightLegacySafeAreaBehaviorTests : XCTestCase
@end

@implementation FlexibleHeaderHeightLegacySafeAreaBehaviorTests {
...
- (void)setUp {
  ...
  // "Legacy" is this flag set to YES.
  _flexibleHeaderView.minMaxHeightIncludesSafeArea = YES;
